...
class BgImage(spriteclass.Sprite):
    def __init__(self):
        ...
        self.bg_image = pygame.image.load("ocean.png").convert_alpha()
...
class Fighter(spriteclass.Sprite):
    def __init__(self, pos):
        ...
        pygame.sprite.Sprite.__init__(self)
        # self.image = pygame.image.load("wall_block.png").convert_alpha()
        self.image = pygame.image.load("fishfighter.png").convert_alpha()
    ...
    # get the route and move the Fish
...
def main():
    ...
    text_2 = "Click LMB to set the Fish."
    text_3 = "Click LMB to set the Worm. Click SPACEBAR to launch the A* algorithm!"
    text_win = "Done!"
    ...
    main_title = "A* Algorithm Test by Kirill!"
